...
Para los no crédulos les dejo aquí un _script_ usando mi código de github para calcularlo.
...
Hay gente que busca de estudiar utilizando sus programas o para situarlos en un espacio político-ideologico o espectro político ideológico (como el izquierda-derecha, el [diagrama de Nolan](https://en.wikipedia.org/wiki/Nolan_Chart), o otros modelos uni-eje o multi-eje) en los cuales podemos medir distancias.
...
* Banzhaf, John F. (1965), _Weighted voting doesn't work: A mathematical analysis_, Rutgers Law Review 19 (2): 317-343
* Downs, Anthony (1957). _An economic theory of democracy_. New York.
